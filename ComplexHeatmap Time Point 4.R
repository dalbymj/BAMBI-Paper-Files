...
# Heatmap for time point 4 (samples from 50+ days of age).
...
seqs_subsampled_all <- dplyr::select(filter(prop_all_metadata_merged,
                                            sample_age %in% c(4)), # Select only rows from Time point 2
...
pdf("ComplexHeatmap time point four 30.11.2018.pdf", width = 3.7, height = 6)
